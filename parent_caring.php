...
<body>
    ...
    <div class="page-intro">
        ...
        <div>Top tips that parents can use to help support the effect of social media usage to teenagers.</div>
    </div>
    <div class="container">
    ...
    <script>
        document.getElementById('you-here').innerHTML = "<p>You are at <b>Parent Caring</b></p>";
    </script>
